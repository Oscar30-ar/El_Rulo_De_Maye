...
<head>
    ...
    <title>El Rulo De Maye | Salón & Spa</title>
...
<body>
    ...
    <main>
        ...
        if (in_array($ruta, $rutasValidas)) {
            if (($ruta == "citas" || $ruta == "admin" || $ruta == "perfil") && !isset($_SESSION["iniciarSesion"])) {
                ...
                echo '<div class="container my-5 text-center"><h3>Acceso denegado para administradores.</h3></div>';
            } else {
    ...
    <!-- 9. Botón Flotante de WhatsApp con mensaje personalizado -->
    <a href="https://wa.me/573001234567?text=Hola%20Maye!%20Deseo%20más%20información%20sobre%20tus%20servicios" 
